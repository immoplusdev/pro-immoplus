...
type ActiveMenu = "all" | "pending" | "approved" | "rejected";

interface Props {
    activeMenu?: ActiveMenu;
}

export function DemandeProParticulierTabs({ activeMenu }: Props) {
    const translate = useTranslate();

    const tabs = [
        {
            key: "all" as const,
            to: "/demandes-pro-particulier",
            label: "Tous",
        ...
        },
        {
            ...
            to: "/demandes-pro-particulier/en-attente",
            label: "En attente",
        ...
        },
        {
            ...
            to: "/demandes-pro-particulier/approuvées",
            label: "Approuvées",
        ...
        },
        {
            ...
            to: "/demandes-pro-particulier/rejetées",
            label: "Rejetées",
