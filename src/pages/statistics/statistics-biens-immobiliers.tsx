...
export function StatisticsBiensImmobiliers() {
    ...
    return (
        <Card
            title={<Title level={5} style={{ margin: 0 }}>Évolution des biens immobiliers</Title>}
            extra={
                <Segmented
